...
export function GenerativeArtScene() {
  ...
  useEffect(() => {
    ...
    // Shader to handle procedural displacement and lighting
    const material = new THREE.ShaderMaterial({
      uniforms: {
        time: { value: 0 },
        pointLightPos: { value: new THREE.Vector3(0, 0, 5) },
        color: { value: new THREE.Color("#E5E7EB") }, // Greyish white
      },
      vertexShader: `
        uniform float time;
  ...
  return <div ref={mountRef} className="absolute inset-0 w-full h-full z-0 opacity-100" />;
}
